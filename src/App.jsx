    ...
    <>
      <div className="container">
        <div className="button-set">
          ...
          <Button size="symbol" type="primary" contentType="image"text="Button CTA" />
        </div>
        <div className="button-set">
          ...
          <Button size="symbol" type="secondary" contentType="image" text="Button CTA" />
        </div>
        <div className="button-set">
          ...
          <Button size="symbol" type="tertiary" contentType="image" text="Button CTA" />
        </div>
        <div className="button-set">
          ...
          <Button size="symbol" type="link-primary" contentType="image" text="Button CTA" />
        </div>
        <div className="button-set">
          ...
          <Button size="symbol" type="link-secondary" contentType="image" text="Button CTA" />
        </div>
        <div className="button-set">
          ...
          <Button size="symbol" type="destructive" contentType="image" text="Button CTA" />
        </div>
      </div>
    </>
  )
